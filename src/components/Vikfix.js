      ...
      <div className="vikfix-wrapper">
        <div className="vikfix-text">
            ...
            <div className="paragraph-pic-box">
                <p>
                    The all natural ding fix.<br/>Fix your ding and don't worry about toxic plastics! Be out in the water in less than 5 minutes!
                </p>
                <Fade right>
                    <img src={require('../assets/matchbox_no_background_small.png')} alt="product" width="249" height="200" />
                </Fade>
            </div>
            <div className="vikfix-buttonWrapper">
                <Link className="learn-more" to="/instructions">
                    <Button style={style.buttonStyle} title="Instructions" type="tertiary" />
                </Link>
            </div>
        </div>
      </div>
